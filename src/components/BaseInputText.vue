<template>
  <div class="input-text-root" :class="{ active }">
    <div class="input-text-wrapper">
      <input
        ...
        @focus="active = true"
        @blur="active = !!$event.target.value"
...
$def-wrap-c3: linear-gradient(to right, $def-wrap-c1, $def-wrap-c2, $def-wrap-c1);
...
div.#{$rootClass} {
  ...
  input {
    ...
    text-shadow: $def-input-c  4px  4px 10px,
...
div.#{$rootClass}.active {
  ...
  div.#{$barClass}::after {
    ...
    box-shadow: $act-bar-c2  7px  2px 10px,
  ...
  input {
    ...
    text-shadow: $act-input-c3  4px  4px 10px,
